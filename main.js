...
var routes = [
    ...
    { path: 'editjug/:id/:nombre/:apellidos/:fechanac', component: _jugadores_editjug_editjug_component__WEBPACK_IMPORTED_MODULE_18__["EditjugComponent"] },
    { path: '**', component: _inicio_inicio_component__WEBPACK_IMPORTED_MODULE_8__["InicioComponent"] }
];
...
var EditjugComponent = /** @class */ (function () {
    function EditjugComponent(pf, jugadorService, router, activatedRouter) {
        ...
        this.activatedRouter.params
            ...
            _this.nombre = parametros['nombre'];
            _this.apellidos = parametros['apellidos'];
            _this.fechanac = parametros['fechanac'];
    ...
    EditjugComponent.prototype.ngOnInit = function () {
        this.jugadoresEditForm = this.pf.group({
            nombre: [this.nombre, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            apellidos: [this.apellidos, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            fechanac: [this.fechanac, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]
        });
    };
    EditjugComponent.prototype.onSubmit = function () {
        ...
        this.jugadorService.guardarJugador(this.saveJugador())
            ...
            _this.fechanac = '';
            console.log('success');
            _this.router.navigate(['/jugadores']);
        });
        // .subscribe(newpre => {
